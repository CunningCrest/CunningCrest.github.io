...
function myFunc() {
    if (document.getElementById("language").innerHTML == "Беларуская") {
        ...
        document.getElementById("before_language").innerHTML = "Google offered in: ";
        ...
        document.getElementById("before_language").innerHTML = "Сервисы Google доступны на разных языках: ";
